...
export default defineConfig({
  testDir: './e2e',
  timeout: 60_000,                 // tope de CADA test: generoso, porque el 1er test paga el cold start
  ...
  retries: 1,                      // 1 retry: absorbe el despertar; si un test pasa recién ahí, sale «flaky»
